  ...
  return (
    <div style={{ padding: "2rem", background: "#f0fcff", minHeight: "100vh" }}>
      ...
      >
        ...
        {prof.department && (
          <p>
            <b>Department:</b> {prof.department}
          </p>
        )}
        {prof.office && (
          <p>
        ...
        {prof.average_rating != null && (
          <p>
            ...
            {prof.review_count != null &&
              ` (${prof.review_count} review${
                prof.review_count === 1 ? "" : "s"
              })`}
          </p>
        )}
          ...
          <>
            ...
            {loading ? (
              ...
              reviews.map((r) => (
                ...
                >
                  <p style={{ fontStyle: "italic", marginBottom: ".25rem" }}>
                    {" "}
                    <Link
                      to={
